...
public enum TransactionKind
{
    ...
    Refund = 2,      // رديات نقدية (إرجاع نقدية فعلية للعميل/من المورد)
    Advance = 3,     // دفعة مقدمة
    Adjustment = 4,  // تسوية (مثل Settlement)
    CreditNote = 5   // إشعار دائن (تحويل رصيد بدون حركة نقدية — ناتج عن مرتجع غير نقدي)
}
...
/// <summary>
/// حالة السندات المالية (للتبع وتجنب الحذف النهائي)
/// </summary>
...
/// <summary>
/// مصدر الحركة المالية للتتبع والتدقيق (Traceability)
/// </summary>
...
/// <summary>
/// نظام המرتجعات الخاص بالشركة
/// </summary>
public enum ReturnProcessMode
{
    Simple = 1,
}
