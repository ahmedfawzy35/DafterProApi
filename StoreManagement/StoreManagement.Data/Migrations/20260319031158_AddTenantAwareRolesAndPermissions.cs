...
{
    /// <inheritdoc />
    public partial class AddTenantAwareRolesAndPermissions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecurringAdjustments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecurringAdjustments_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoanInstallments_EmployeeLoans_LoanId",
                        column: x => x.LoanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollRunItems_PayrollRunId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringAdjustments_EmployeeId",
